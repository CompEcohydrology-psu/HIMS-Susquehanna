...
# Land scape simulation for one subbasin
...
source(".../Separator.R") # subbasin separator function

source(".../Paramread.R") # read parameters
...
#######################################      
      ...
      ######################copy climate change .pcp and .tmp files############################
       ...
       flist<-list.files(path="/storage/home/abh6005/work/swat/climate/GFDL-CM4/ssp245",full.names = TRUE)
      ...
      system('./swat2012_664')  # Run SWAT executable

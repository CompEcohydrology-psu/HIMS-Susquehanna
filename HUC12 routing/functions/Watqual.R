...
Watqual<-function( varoute_2,rchwtr,rchdep,tmpav,hru_ra,dayl,
  ...
  # initialize inflow concentrations
    ...
    orgnin <- 1000. * varoute_4  / wtrin   # convert to mg/L
    
    ammoin <- 1000. * varoute_14   / wtrin
    
    nitritin <- 1000. * varoute_15  / wtrin
    
    nitratin <- 1000. * varoute_6  / wtrin
    
    orgpin <- 1000. * varoute_5  / wtrin
    
    dispin <- 1000. * varoute_7 / wtrin
  ...
  #}
   ...
   output<-c(algae,chlora, organicn, ammonian, nitriten, nitraten,  organicp,
             disolvp, rch_cbod,rch_dox,tmpav,varoute_4,varoute_5,varoute_6, varoute_7,varoute_13,
                           varoute_14,varoute_15,varoute_16,varoute_17)
